...
final scheduleLibraryActivitiesProvider = FutureProvider.autoDispose.family<List<TemplateActivity>, String>((ref, phaseId) async {
  final repo = ref.read(scheduleLibraryRepositoryProvider);
  return repo.getTemplatePhaseActivities(phaseId);
});

final scheduleLibraryMilestonesProvider = FutureProvider.autoDispose<List<TemplateMilestone>>((ref) async {
  final repo = ref.read(scheduleLibraryRepositoryProvider);
...
class ScheduleNotifier extends AsyncNotifier<void> {
  ...
  Future<void> createActivity(String scheduleId, String phaseId, {String? projectId, String? bidId, required Map<String, dynamic> data}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> updateActivity(String scheduleId, String phaseId, String activityId, {String? projectId, String? bidId, required Map<String, dynamic> data}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> deleteActivity(String scheduleId, String phaseId, String activityId, {String? projectId, String? bidId}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> createPhase(String scheduleId, {String? projectId, String? bidId, required Map<String, dynamic> data}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> updatePhase(String scheduleId, String phaseId, {String? projectId, String? bidId, required Map<String, dynamic> data}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> deletePhase(String scheduleId, String phaseId, {String? projectId, String? bidId}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> importTemplates(String scheduleId, {String? projectId, String? bidId, required List<ScheduleImportSelection> selections}) async {
    state = const AsyncLoading();
    try {
  ...
  Future<void> submitSchedule(String scheduleId, String? projectId, String? bidId, String contractorNotes) async {
    ...
    try {
      if (bidId != null) {
        await _repository.submitScheduleFromBid(bidId, contractorNotes);
      } else {
