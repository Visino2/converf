...
class ContractorBiddingPreferencesScreen extends StatefulWidget {
  ...
  @override
  State<ContractorBiddingPreferencesScreen> createState() => _ContractorBiddingPreferencesScreenState();
}

class _ContractorBiddingPreferencesScreenState extends State<ContractorBiddingPreferencesScreen> {
  bool _autoSuggest = false;
  double _minBudget = 2500000;

  final List<String> _projectTypes = ['Residential', 'Commercial', 'Industrial', 'Infrastructure', 'Roadway'];
  final List<String> _locations = ['Lagos, Ng', 'Abuja, NG', 'Nairobi, Kenya', 'Accra, Ghana'];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: _projectTypes.map((type) => _buildChip(type, true)).toList(),
                    ),
                    const SizedBox(height: 16),
                    SizedBox(
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: _locations.map((loc) => _buildChip(loc, false)).toList(),
                    ),
                    const SizedBox(height: 24),
                    SizedBox(
                      width: double.infinity,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF276572)),
                        ),
                      ],
                    ),
                    ...
                    const Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('N0', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF6B7280))),
                          Text('N100M+', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF6B7280))),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget _buildChip(String label, bool isProjectType) {
    if (isProjectType) {
      ...
      return Container(
        ...
        child: Text(
          label,
          style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFF276572)),
        ),
      );
    }
  }
