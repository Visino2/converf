...
class _LogInspectionScreenState extends ConsumerState<LogInspectionScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(inspectionActionProvider.notifier).createInspection(widget.projectId, payload);
      if (mounted) {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              scheduleAsync.when(
                data: (schedule) => DropdownButtonFormField<String>(
                  ...
                  items: schedule.phases.map((p) => DropdownMenuItem(value: p.name, child: Text(p.name))).toList(),
                  onChanged: (val) => setState(() => _selectedPhase = val),
                  hint: const Text('Select Phase'),
                ),
                loading: () => const LinearProgressIndicator(),
                error: (_, __) => const Text('Error loading phases'),
              ),
              const SizedBox(height: 24),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: 80,
                      decoration: BoxDecoration(
                        border: Border.all(color: const Color(0xFFD0D5DD), style: BorderStyle.solid), // Actually I want dashed
                        borderRadius: BorderRadius.circular(8),
                      ...
                      child: const Column(
                        ...
                        children: [
                          Icon(Icons.camera_alt_outlined, color: Color(0xFF667085)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: isSubmitting
                      ...
                      : const Text('Submit Inspection', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
                ),
              ),
            ],
          ),
